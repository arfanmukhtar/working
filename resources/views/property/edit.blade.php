                                ...
                                <div class="col-lg-12">
									...
									<div class="col-md-12 col-sm-12">
										<div class="form-group">
											 <select name="related[]" id='pre-selected-options' multiple='multiple'>
												<?php $related_list = explode("," , $property->related); foreach($properties as $list) { ?>
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
											<a href="<?php echo url("listing/image_delete/" . $list->id); ?>" title="Remove Image"> <i class="fa fa-times"> </i> </a>
										 	<img class="img-responsive" src="<?php echo url("assets/images/uploads/". $property->user_id . "/" . $property->id . "/" . $list->image_name); ?>">
